...
/**
 * This code snippet deletes a knowledge base document.
     ...
     const integrationObject = {
        dialogflowEsIntegration: {
          dialogflowKnowledgeBases: [
            {
              displayName: 'My first knowledge base',
              documents: [] // Assumption: Previously, there was only 1 document in the knowledge base.
            }
          ]
        }
     };
