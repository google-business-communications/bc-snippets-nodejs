...
async function main() {
  ...
  const greetingName = 'brands/' + BRAND_ID + '/agents/' + AGENT_ID + '/greetings/' + GREETING_ID;
  ...
  if (authClient) {
    ...
    const apiParams = {
      auth: authClient,
      name: greetingName,
      resource: greetingObject,
      updateMask: 'welcomeMessages,customId'
    };

    bcApi.brands.agents.greetings.patch(apiParams, {}, (err, response) => {
